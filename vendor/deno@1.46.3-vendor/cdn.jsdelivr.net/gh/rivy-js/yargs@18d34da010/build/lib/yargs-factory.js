...
export class YargsInstance {
  ...
  demandCommand(min = 1, max, minMsg, maxMsg) {
    ...
    this.global("_", false);
    __classPrivateFieldGet(this, _YargsInstance_options, "f").demandedCommands
      ._ = {
        min,
        max,
        minMsg,
  ...
  deprecateOption(option, message) {
    ...
    __classPrivateFieldGet(this, _YargsInstance_options, "f")
      .deprecatedOptions[option] = message;
    return this;
  }
  ...
  async getCompletion(args, done) {
    ...
    if (!done) {
      ...
      return __classPrivateFieldGet(this, _YargsInstance_completion, "f")
  ...
  group(opts, groupName) {
    ...
    const existing = __classPrivateFieldGet(
      this,
      _YargsInstance_preservedGroups,
      "f",
    )[groupName] ||
    ...
    const seen = {};
    __classPrivateFieldGet(this, _YargsInstance_groups, "f")[groupName] =
      (existing || []).concat(opts).filter((key) => {
        if (seen[key]) {
          return false;
        }
  ...
  hide(key) {
    ...
    __classPrivateFieldGet(this, _YargsInstance_options, "f").hiddenOptions
      .push(key);
    return this;
  }
  implies(key, value) {
  ...
  locale(locale) {
    ...
    if (locale === undefined) {
      this[kGuessLocale]();
      return __classPrivateFieldGet(this, _YargsInstance_shim, "f").y18n
        .getLocale();
    }
  ...
  middleware(callback, applyBeforeValidation, global) {
    return __classPrivateFieldGet(this, _YargsInstance_globalMiddleware, "f")
  ...
  positional(key, opts) {
    ...
    const fullCommand =
      __classPrivateFieldGet(this, _YargsInstance_context, "f")
        .fullCommands[
  ...
  [kDeleteFromParserHintObject](optionKey) {
    objectKeys(__classPrivateFieldGet(this, _YargsInstance_options, "f"))
      .forEach((hintKey) => {
        if (((key) => key === "configObjects")(hintKey)) {
          return;
        }
        const hint =
          __classPrivateFieldGet(this, _YargsInstance_options, "f")[hintKey];
    ...
    delete __classPrivateFieldGet(this, _YargsInstance_usage, "f")
  ...
  [kEmitWarning](warning, type, deduplicationId) {
    if (
      ...
      __classPrivateFieldGet(this, _YargsInstance_shim, "f").process
  ...
  [kFreeze]() {
    __classPrivateFieldGet(this, _YargsInstance_frozens, "f").push({
      ...
      configObjects: __classPrivateFieldGet(this, _YargsInstance_options, "f")
  ...
  [kGetDollarZero]() {
    ...
    if (
      ...
      default$0 = __classPrivateFieldGet(this, _YargsInstance_shim, "f").process
        .argv().slice(1, 2);
    } else {
      default$0 = __classPrivateFieldGet(this, _YargsInstance_shim, "f").process
        .argv().slice(0, 1);
  ...
  [kParsePositionalNumbers](argv) {
    ...
    for (let i = 0, arg; (arg = args[i]) !== undefined; i++) {
      if (
        __classPrivateFieldGet(this, _YargsInstance_shim, "f").Parser
          .looksLikeNumber(arg) &&
  ...
  [kPkgUp](rootPath) {
    ...
    try {
      ...
      if (
        ...
        startDir = __classPrivateFieldGet(this, _YargsInstance_shim, "f").path
          .dirname(startDir);
      }
      const pkgJsonPath = __classPrivateFieldGet(this, _YargsInstance_shim, "f")
  ...
  [kUnfreeze]() {
    ...
    const frozen = __classPrivateFieldGet(this, _YargsInstance_frozens, "f")
      .pop();
    assertNotStrictEqual(
      frozen,
      undefined,
  ...
  getInternalMethods() {
    return {
      ...
      runYargsParserAndExecuteCommands: this[kRunYargsParserAndExecuteCommands]
        .bind(this),
  ...
  [kReset](aliases = {}) {
    ...
    Object.assign(
      __classPrivateFieldGet(this, _YargsInstance_preservedGroups, "f"),
      Object.keys(__classPrivateFieldGet(this, _YargsInstance_groups, "f"))
        .reduce((acc, groupName) => {
          const keys = __classPrivateFieldGet(
            this,
            _YargsInstance_groups,
            "f",
          )[groupName].filter((key) => !(key in localLookup));
          if (keys.length > 0) {
            acc[groupName] = keys;
          }
          return acc;
  ...
  [kRunYargsParserAndExecuteCommands](
    ...
    const parsed = __classPrivateFieldGet(this, _YargsInstance_shim, "f").Parser
      .detailed(
        args,
        Object.assign(
          {},
    ...
    try {
      ...
      if (
        __classPrivateFieldGet(this, _YargsInstance_command, "f")
          .hasDefaultCommand() && !skipRecommendation
      ) {
        const innerArgv = __classPrivateFieldGet(
          this,
          _YargsInstance_command,
  ...
  [kTrackManuallySetKeys](keys) {
    if (typeof keys === "string") {
      __classPrivateFieldGet(this, _YargsInstance_options, "f").key[keys] =
        true;
    } else {
      for (const k of keys) {
