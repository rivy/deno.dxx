...
export class Completion {
  constructor(yargs, usage, command, shim) {
    ...
    this.zshShell =
      (_c = ((_a = this.shim.getEnv("SHELL")) === null || _a === void 0
            ? void 0
            : _a.includes("zsh")) ||
  ...
  completeOptionKey(key, completions, current, negable) {
    ...
    if (this.zshShell) {
      ...
      const aliasKey = (_b = (_a = this === null || this === void 0
                    ? void 0
                    : this.aliases) === null || _a === void 0
              ? void 0
      ...
      const desc = (_d = (_c = descs[key]) !== null && _c !== void 0
              ? _c
              : descFromAlias) !== null && _d !== void 0
        ? _d
        : "";
