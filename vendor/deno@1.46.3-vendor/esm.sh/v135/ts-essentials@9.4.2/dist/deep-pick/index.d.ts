...
import { DeepModify } from "../deep-modify.d.ts";
export declare type DeepPick<Type, Filter extends DeepModify<Type>> =
  Type extends Builtin ? Type
    ...
    : Filter extends AnyRecord ? {
        [Key in keyof Type as Key extends keyof Filter ? Key : never]:
          Filter[Key & keyof Filter] extends true ? Type[Key]
