...
export declare type DeepModify<Type> =
  | (Type extends AnyRecord ? {
      [Key in keyof Type]?: undefined extends {
        ...
        : true
        : Type[Key] extends object ? true | DeepModify<Type[Key]>
        : true;
    }
    : never)
  ...
  | (Type extends ReadonlySet<infer Values> ? ReadonlySet<DeepModify<Values>>
    : never)
  | (Type extends WeakSet<infer Values> ? WeakSet<DeepModify<Values>> : never)
  | (Type extends Map<infer Keys, infer Values> ? Map<Keys, DeepModify<Values>>
    : never)
  | (Type extends ReadonlyMap<infer Keys, infer Values>
    ? ReadonlyMap<Keys, DeepModify<Values>>
    : never)
  | (Type extends WeakMap<infer Keys, infer Values>
    ? WeakMap<Keys, DeepModify<Values>>
    : never);
