...
export declare type DeepNonNullable<Type> = Type extends Builtin
  ? NonNullable<Type>
  ...
  : Type extends Set<infer Values> ? Set<DeepNonNullable<Values>>
  : Type extends ReadonlySet<infer Values>
    ? ReadonlySet<DeepNonNullable<Values>>
  : Type extends WeakSet<infer Values> ? WeakSet<DeepNonNullable<Values>>
  : Type extends Promise<infer Values> ? Promise<DeepNonNullable<Values>>
  : Type extends {} ? {
