import type { $ZodCheck, $ZodStringFormats } from "./checks.d.ts";
import { $constructor } from "./core.d.ts";
...
export declare function flattenError<T>(
  error: $ZodError<T>,
): _FlattenedError<T>;
export declare function flattenError<T, U>(
  error: $ZodError<T>,
...
export declare function formatError<T>(
  error: $ZodError<T>,
): $ZodFormattedError<T>;
export declare function formatError<T, U>(
  error: $ZodError<T>,
  mapper?: (issue: $ZodIssue) => U,
