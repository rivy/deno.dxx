...
export declare function string<T = unknown>(
...
export interface ZodCoercedBoolean<T = unknown>
  extends schemas._ZodBoolean<core.$ZodBooleanInternals<T>> {
}
export declare function boolean<T = unknown>(
  params?: string | core.$ZodBooleanParams,
): ZodCoercedBoolean<T>;
export interface ZodCoercedBigInt<T = unknown>
  extends schemas._ZodBigInt<core.$ZodBigIntInternals<T>> {
}
export declare function bigint<T = unknown>(
  params?: string | core.$ZodBigIntParams,
): ZodCoercedBigInt<T>;
export interface ZodCoercedDate<T = unknown>
  extends schemas._ZodDate<core.$ZodDateInternals<T>> {
}
export declare function date<T = unknown>(
  params?: string | core.$ZodDateParams,
): ZodCoercedDate<T>;
