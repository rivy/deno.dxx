import * as core from "../core/index.d.ts";
import { util } from "../core/index.d.ts";
import * as parse from "./parse.d.ts";
...
> extends core.$ZodType<Output, Input, Internals> {
  ...
  check(
    ...checks:
      (core.CheckFn<core.output<this>> | core.$ZodCheck<core.output<this>>)[]
  ): this;
  ...
  brand<T extends PropertyKey = PropertyKey>(
    value?: T,
  ): PropertyKey extends T ? this : core.$ZodBranded<this, T>;
  parse(
    data: unknown,
...
export interface _ZodString<
  T extends core.$ZodStringInternals<unknown> = core.$ZodStringInternals<
    unknown
  >,
> extends _ZodType<T> {
  format: string | null;
...
export declare function uuidv7(
...
export declare function cidrv4(
...
export declare function cidrv6(
...
export declare function base64(
...
export interface _ZodBoolean<
  T extends core.$ZodBooleanInternals = core.$ZodBooleanInternals,
> extends _ZodType<T> {
}
...
export interface _ZodBigInt<
  T extends core.$ZodBigIntInternals = core.$ZodBigIntInternals,
> extends _ZodType<T> {
...
export interface _ZodDate<
  T extends core.$ZodDateInternals = core.$ZodDateInternals,
> extends _ZodType<T> {
  min(
    value: number | Date,
...
export declare function array<T extends core.SomeType>(
  element: T,
...
> extends
  _ZodType<core.$ZodObjectInternals<Shape, Config>>,
  core.$ZodObject<Shape, Config> {
  shape: Shape;
  keyof(): ZodEnum<util.ToEnum<keyof Shape & string>>;
  /** Define a schema to validate all unrecognized keys. This overrides the existing strict/loose behavior. */
  catchall<T extends core.SomeType>(
    schema: T,
  ): ZodObject<Shape, core.$catchall<T>>;
  ...
  required<M extends util.Mask<keyof Shape>>(mask: M): ZodObject<
    {
      [k in keyof Shape]: k extends keyof M ? ZodNonOptional<Shape[k]>
        : Shape[k];
    },
    Config
  >;
...
export declare function union<const T extends readonly core.SomeType[]>(
  options: T,
...
> extends
  _ZodType<core.$ZodIntersectionInternals<A, B>>,
...
export declare function intersection<
  T extends core.SomeType,
  U extends core.SomeType,
>(left: T, right: U): ZodIntersection<T, U>;
...
> extends _ZodType<core.$ZodTupleInternals<T, Rest>>, core.$ZodTuple<T, Rest> {
  rest<Rest extends core.SomeType = core.$ZodType>(
    rest: Rest,
  ): ZodTuple<T, Rest>;
}
...
> extends
  _ZodType<core.$ZodRecordInternals<Key, Value>>,
...
export declare function partialRecord<
  Key extends core.$ZodRecordKey,
  Value extends core.SomeType,
>(
  keyType: Key,
...
export interface ZodMap<
  ...
  Value extends core.SomeType = core.$ZodType,
> extends
  _ZodType<core.$ZodMapInternals<Key, Value>>,
...
export declare function set<Value extends core.SomeType>(
  valueType: Value,
...
declare function _enum<const T extends util.EnumLike>(
  entries: T,
  params?: string | core.$ZodEnumParams,
): ZodEnum<T>;
 ...
 * ```
 */
export declare function nativeEnum<T extends util.EnumLike>(
  entries: T,
  params?: string | core.$ZodEnumParams,
): ZodEnum<T>;
...
export declare function literal<const T extends util.Literal>(
  value: T,
  params?: string | core.$ZodLiteralParams,
): ZodLiteral<T>;
...
export interface ZodTransform<O = unknown, I = unknown>
  extends
    _ZodType<core.$ZodTransformInternals<O, I>>,
...
export declare function optional<T extends core.SomeType>(
  innerType: T,
): ZodOptional<T>;
...
export declare function nullable<T extends core.SomeType>(
  innerType: T,
): ZodNullable<T>;
export declare function nullish<T extends core.SomeType>(
  innerType: T,
...
export declare function _default<T extends core.SomeType>(
  innerType: T,
  defaultValue:
...
export declare function prefault<T extends core.SomeType>(
  innerType: T,
...
export declare function nonoptional<T extends core.SomeType>(
  innerType: T,
  params?: string | core.$ZodNonOptionalParams,
): ZodNonOptional<T>;
...
export declare function success<T extends core.SomeType>(
  innerType: T,
): ZodSuccess<T>;
...
declare function _catch<T extends core.SomeType>(
  innerType: T,
...
export declare function pipe<
  ...
  B extends core.$ZodType<unknown, core.output<A>> = core.$ZodType<
    unknown,
    core.output<A>
  >,
...
export interface ZodTemplateLiteral<Template extends string = string>
  extends
    _ZodType<core.$ZodTemplateLiteralInternals<Template>>,
    core.$ZodTemplateLiteral<Template> {
}
export declare const ZodTemplateLiteral: core.$constructor<ZodTemplateLiteral>;
export declare function templateLiteral<
  const Parts extends core.$ZodTemplateLiteralPart[],
>(
  parts: Parts,
...
export declare function lazy<T extends core.SomeType>(
  getter: () => T,
): ZodLazy<T>;
...
export declare function refine<T>(
...
>;
declare function _instanceof<T extends typeof util.Class>(
  cls: T,
