...
import type { ZodType } from "./schemas.d.ts";
export type {
...
export type inferFlattenedErrors<T extends core.$ZodType, U = string> =
  core.$ZodFlattenedError<core.output<T>, U>;
/** @deprecated Use `z.$ZodFormattedError` */
export type inferFormattedError<T extends core.$ZodType<any, any>, U = string> =
...
export { $brand, config } from "../core/index.d.ts";
/** @deprecated Use `z.config(params)` instead. */
export declare function setErrorMap(map: core.$ZodErrorMap): void;
/** @deprecated Use `z.config()` instead. */
export declare function getErrorMap():
  | core.$ZodErrorMap<core.$ZodIssue>
  | undefined;
export type {
