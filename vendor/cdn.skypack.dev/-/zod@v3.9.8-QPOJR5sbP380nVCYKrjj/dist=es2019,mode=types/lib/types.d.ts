...
import { AsyncParseReturnType, ParseContext, ParseParamsNoData, ParseReturnType, SyncParseReturnType, ZodParsedType } from "./helpers/parseUtil.d.ts";
import { partialUtil } from "./helpers/partialUtil.d.ts";
import { util } from "./helpers/util.d.ts";
...
export declare abstract class ZodType<Output, Def extends ZodTypeDef = ZodTypeDef, Input = Output> {
    ...
    addIssue(ctx: ParseContext, issueData: IssueData, params: {
        data: any;
    }): void;
    _parseSync(_ctx: ParseContext, _data: any, _parsedType: ZodParsedType): SyncParseReturnType<Output>;
    _parseAsync(_ctx: ParseContext, _data: any, _parsedType: ZodParsedType): AsyncParseReturnType<Output>;
    ...
    safeParseAsync(data: unknown, params?: Partial<ParseParamsNoData>): Promise<{
        success: true;
        data: Output;
    } | {
        success: false;
    ...
    spa: (data: unknown, params?: Partial<ParseParamsNoData> | undefined) => Promise<{
        success: true;
        data: Output;
    } | {
        success: false;
    ...
    superRefine: (refinement: RefinementEffect<Output>["refinement"]) => ZodEffects<this>;
    constructor(def: Def);
...
export declare class ZodString extends ZodType<string, ZodStringDef> {
    ...
    protected _regex: (regex: RegExp, validation: StringValidation, message?: errorUtil.ErrMessage | undefined) => ZodEffects<this, this["_output"], this["_input"]>;
...
export declare class ZodRecord<Key extends KeySchema = ZodString, Value extends ZodTypeAny = ZodTypeAny> extends ZodType<Record<Key["_output"], Value["_output"]>, ZodRecordDef<Key, Value>, Record<Key["_input"], Value["_input"]>> {
    ...
    _parse(ctx: ParseContext, data: any, parsedType: ZodParsedType): ParseReturnType<Record<any, any>>;
    get element(): Value;
...
export declare class ZodEffects<T extends ZodTypeAny, Output = T["_output"], Input = T["_input"]> extends ZodType<Output, ZodEffectsDef<T>, Input> {
    innerType(): T;
    _parse(ctx: ParseContext, initialData: any, initialParsedType: ZodParsedType): ParseReturnType<Output>;
