...
export class BufWriterSync extends AbstractBufBase implements WriterSync {
    ...
    static create(writer: WriterSync, size: number = DEFAULT_BUF_SIZE): BufWriterSync {
...
export async function* readDelim(reader: Reader, delim: Uint8Array): AsyncIterableIterator<Uint8Array> {
...
export async function* readStringDelim(reader: Reader, delim: string, decoderOpts?: {
    encoding?: string;
    fatal?: boolean;
    ignoreBOM?: boolean;
