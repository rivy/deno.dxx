...
import { getResultCard, prettyBenchmarkCardResultOptions, } from "./benchmark_result_card.ts";
...
export type prettyBenchmarkResultOptions = CommonOptions & (prettyBenchmarkCardResultOptions);
...
options?: prettyBenchmarkResultOptions) {
    return (result: BenchmarkRunResult) => _prettyBenchmarkResultCb(result, options);
}
function _prettyBenchmarkResultCb(results: BenchmarkRunResult, options?: prettyBenchmarkResultOptions) {
    if (options?.nocolor) {
