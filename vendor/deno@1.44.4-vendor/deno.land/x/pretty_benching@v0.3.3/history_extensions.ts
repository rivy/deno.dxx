...
import type { DeltaKey, prettyBenchmarkHistory, } from "./pretty_benchmark_history.ts";
...
export function deltaColumn<T = unknown>(history: prettyBenchmarkHistory<T>, options?: {
    key: DeltaKey<T>;
}): ColumnDefinition {
...
export function historyColumns<T = unknown>(history: prettyBenchmarkHistory<T>, options?: {
    key?: DeltaKey<T>;
