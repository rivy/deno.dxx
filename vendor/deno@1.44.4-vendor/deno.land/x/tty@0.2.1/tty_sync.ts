...
import { CLEAR_DOWN, CLEAR_LEFT, CLEAR_LINE, CLEAR_RIGHT, CLEAR_SCREEN, CLEAR_UP, DOWN, ESC, HIDE, HOME, LEFT, NEXT_LINE, POSITION, PREV_LINE, RESTORE, RIGHT, SCROLL_DOWN, SCROLL_UP, SHOW, type SyncStream, UP, } from "./mod.ts";
...
export function cursorSync(action: string, writer: SyncStream = Deno.stdout): void {
...
export function goToSync(x: number, y: number, writer: SyncStream = Deno.stdout): void {
