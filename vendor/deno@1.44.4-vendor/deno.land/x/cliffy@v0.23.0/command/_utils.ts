...
export function didYouMeanCommand(command: string, commands: Array<Command>, excludes: Array<string> = []): string {
 ...
 */
export function parseArgumentsDefinition<T extends boolean>(argsDefinition: string, validate: boolean, all: true): Array<IArgument | string>;
export function parseArgumentsDefinition<T extends boolean>(argsDefinition: string, validate?: boolean, all?: false): Array<IArgument>;
export function parseArgumentsDefinition<T extends boolean>(argsDefinition: string, validate = true, all?: T): T extends true ? Array<IArgument | string> : Array<IArgument> {
    ...
    return argumentDetails as (T extends true ? Array<IArgument | string> : Array<IArgument>);
}
