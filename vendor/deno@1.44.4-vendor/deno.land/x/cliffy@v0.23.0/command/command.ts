...
import type { IAction, IArgument, ICommandGlobalOption, ICommandOption, ICompleteHandler, ICompleteOptions, ICompletion, IDescription, IEnvVar, IEnvVarOptions, IEnvVarValueHandler, IExample, IFlagValueHandler, IGlobalEnvVarOptions, IHelpHandler, IOption, IParseResult, IType, ITypeInfo, ITypeOptions, IVersionHandler, MapTypes, TypeOrTypeHandler, } from "./types.ts";
import { IntegerType } from "./types/integer.ts";
import { underscoreToCamelCase } from "../flags/_utils.ts";
export class Command<CPG extends Record<string, any> | void = void, CPT extends Record<string, any> | void = CPG extends number ? any : void, CO extends Record<string, any> | void = CPG extends number ? any : void, CA extends Array<unknown> = CPG extends number ? any : [
], CG extends Record<string, any> | void = CPG extends number ? any : void, CT extends Record<string, any> | void = CPG extends number ? any : {
    number: number;
    integer: number;
    string: string;
    boolean: boolean;
}, CGT extends Record<string, any> | void = CPG extends number ? any : void, CP extends Command<any> | undefined = CPG extends number ? any : undefined> {
     ...
     */
    public versionOption(flags: string, desc?: string, opts?: ICommandOption<Partial<CO>, CA, CG, CPG, CT, CGT, CPT, CP> & {
        global: true;
    }): this;
    /**
     * Set version option.
     ...
     * @param opts  Version option options.
     */
    public versionOption(flags: string, desc?: string, opts?: ICommandOption<CO, CA, CG, CPG, CT, CGT, CPT, CP>): this;
    /**
     * Set version option.
     * @param flags The flags of the version option.
     * @param desc  The description of the version option.
     ...
     */
    public versionOption(flags: string, desc?: string, opts?: IAction<CO, CA, CG, CPG, CT, CGT, CPT, CP>): this;
    public versionOption(flags: string | false, desc?: string, opts?: IAction<CO, CA, CG, CPG, CT, CGT, CPT, CP> | ICommandOption<CO, CA, CG, CPG, CT, CGT, CPT, CP> | ICommandOption<Partial<CO>, CA, CG, CPG, CT, CGT, CPT, CP> & {
        global: true;
    }): this {
     ...
     */
    public helpOption(flags: string, desc?: string, opts?: ICommandOption<Partial<CO>, CA, CG, CPG, CT, CGT, CPT, CP> & {
        global: true;
    }): this;
    /**
     * Set help option.
     ...
     * @param opts  Help option options.
     */
    public helpOption(flags: string, desc?: string, opts?: ICommandOption<CO, CA, CG, CPG, CT, CGT, CPT, CP>): this;
    /**
     * Set help option.
     * @param flags The flags of the help option.
     * @param desc  The description of the help option.
     ...
     */
    public helpOption(flags: string, desc?: string, opts?: IAction<CO, CA, CG, CPG, CT, CGT, CPT, CP>): this;
    public helpOption(flags: string | false, desc?: string, opts?: IAction<CO, CA, CG, CPG, CT, CGT, CPT, CP> | ICommandOption<CO, CA, CG, CPG, CT, CGT, CPT, CP> | ICommandOption<Partial<CO>, CA, CG, CPG, CT, CGT, CPT, CP> & {
        global: true;
    }): this {
     ...
     */
    public command<C extends Command<G | void | undefined, T | void | undefined, Record<string, any> | void, Array<unknown>, Record<string, any> | void, Record<string, any> | void, Record<string, any> | void, OneOf<CP, this> | undefined>, G extends (CP extends Command<any> ? CPG : Merge<CPG, CG>), T extends (CP extends Command<any> ? CPT : Merge<CPT, CT>)>(name: string, cmd: C, override?: boolean): C extends Command<any, any, infer Options, infer Arguments, infer GlobalOptions, infer Types, infer GlobalTypes, any> ? Command<G, T, Options, Arguments, GlobalOptions, Types, GlobalTypes, OneOf<CP, this>> : never;
    /**
     * Add new sub-command.
     * @param name      Command definition. E.g: `my-command <input-file:string> <output-file:string>`
     ...
     * @param override  Override existing child command.
     */
    public command<N extends string, A extends TypedCommandArguments<N, CP extends Command<any> ? CPT : Merge<CPT, CGT>>>(name: N, desc?: string, override?: boolean): CPG extends number ? Command<any> : Command<CP extends Command<any> ? CPG : Merge<CPG, CG>, CP extends Command<any> ? CPT : Merge<CPT, CGT>, void, A, void, void, void, OneOf<CP, this>>;
    /**
     * Add new sub-command.
     ...
     * @param override          Override existing child command.
     */
    command(nameAndArguments: string, cmdOrDescription?: Command<any> | string, override?: boolean): Command<any> {
     ...
     */
    public select<O extends Record<string, unknown> | void = any, A extends Array<unknown> = any, G extends Record<string, unknown> | void = any>(name: string): Command<CPG, CPT, O, A, G, CT, CGT, CP> {
     ...
     */
    public version(version: string | IVersionHandler<Partial<CO>, Partial<CA>, CG, CPG, CT, CGT, CPT, CP>): this {
     ...
     */
    public help(help: string | IHelpHandler<Partial<CO>, Partial<CA>, CG, CPG> | HelpOptions): this {
        if (typeof help === "string") {
            ...
            this.cmd._help = (cmd: Command, options: HelpOptions): string => HelpGenerator.generate(cmd, { ...help, ...options });
        }
        return this;
    }
    /**
     ...
     */
    public description(description: IDescription<CO, CA, CG, CPG, CT, CGT, CPT, CP>): this {
     ...
     */
    public arguments<A extends TypedArguments<N, Merge<CPT, Merge<CGT, CT>>>, N extends string = string>(args: N): Command<CPG, CPT, CO, A, CG, CT, CGT, CP> {
     ...
     */
    public useRawArgs(useRawArgs = true): Command<CPG, CPT, CO, Array<string>, CG, CT, CGT, CP> {
    ...
    public globalType<H extends TypeOrTypeHandler<unknown>, N extends string = string>(name: N, handler: H, options?: Omit<ITypeOptions, "global">): Command<CPG, CPT, CO, CA, CG, CT, Merge<CGT, TypedType<N, H>>, CP> {
     ...
     */
    public type<H extends TypeOrTypeHandler<unknown>, N extends string = string>(name: N, handler: H, options?: ITypeOptions): Command<CPG, CPT, CO, CA, CG, Merge<CT, TypedType<N, H>>, CGT, CP> {
        ...
        if (handler instanceof Type &&
            ...
            const completeHandler: ICompleteHandler = (cmd: Command, parent?: Command) => handler.complete?.(cmd, parent) || [];
            this.complete(name, completeHandler, options);
        }
        return this as Command<any>;
    }
    public globalComplete(name: string, complete: ICompleteHandler, options?: Omit<ICompleteOptions, "global">): this {
     ...
     */
    public complete(name: string, complete: ICompleteHandler<Partial<CO>, Partial<CA>, CG, CPG, CT, CGT, CPT, any>, options: ICompleteOptions & {
        global: boolean;
    }): this;
    public complete(name: string, complete: ICompleteHandler<CO, CA, CG, CPG, CT, CGT, CPT, CP>, options?: ICompleteOptions): this;
    complete(name: string, complete: ICompleteHandler<CO, CA, CG, CPG, CT, CGT, CPT, CP> | ICompleteHandler<Partial<CO>, Partial<CA>, CG, CPG, CT, CGT, CPT, any>, options?: ICompleteOptions): this {
    ...
    public globalOption<F extends string, G extends TypedOption<F, CO, Merge<CPT, Merge<CGT, CT>>, R, D>, MG extends MapValue<G, V, C>, R extends ICommandOption["required"] = undefined, C extends ICommandOption["collect"] = undefined, D = undefined, V = undefined>(flags: F, desc: string, opts?: Omit<ICommandGlobalOption<Partial<CO>, CA, MergeOptions<F, CG, G>, CPG, CT, CGT, CPT, CP>, "value"> & {
        default?: IDefaultValue<D>;
        required?: R;
        collect?: C;
        value?: IFlagValueHandler<MapTypes<ValueOf<G>>, V>;
    } | IFlagValueHandler<MapTypes<ValueOf<G>>, V>): Command<CPG, CPT, CO, CA, MergeOptions<F, CG, MG>, CT, CGT, CP> {
        if (typeof opts === "function") {
            return this.option(flags, desc, { value: opts, global: true } as ICommandOption) as Command<any>;
        }
        return this.option(flags, desc, { ...opts, global: true } as ICommandOption) as Command<any>;
    }
    /**
     * Add a new option.
     ...
     */
    public option<F extends string, G extends TypedOption<F, CO, Merge<CPT, Merge<CGT, CT>>, R, D>, MG extends MapValue<G, V, C>, R extends ICommandOption["required"] = undefined, C extends ICommandOption["collect"] = undefined, D = undefined, V = undefined>(flags: F, desc: string, opts: Omit<ICommandOption<Partial<CO>, CA, MergeOptions<F, CG, G>, CPG, CT, CGT, CPT, CP>, "value"> & {
        global: true;
        default?: IDefaultValue<D>;
        required?: R;
        collect?: C;
    ...
    public option<F extends string, O extends TypedOption<F, CO, Merge<CPT, Merge<CGT, CT>>, R, D>, MO extends MapValue<O, V, C>, R extends ICommandOption["required"] = undefined, C extends ICommandOption["collect"] = undefined, D = undefined, V = undefined>(flags: F, desc: string, opts?: Omit<ICommandOption<MergeOptions<F, CO, O>, CA, CG, CPG, CT, CGT, CPT, CP>, "value"> & {
        default?: IDefaultValue<D>;
        required?: R;
        collect?: C;
        value?: IFlagValueHandler<MapTypes<ValueOf<O>>, V>;
    } | IFlagValueHandler<MapTypes<ValueOf<O>>, V>): Command<CPG, CPT, MergeOptions<F, CO, MO>, CA, CG, CT, CGT, CP>;
    public option(flags: string, desc: string, opts?: ICommandOption | IFlagValueHandler): Command<any> {
        if (typeof opts === "function") {
    ...
    public globalEnv<N extends string, G extends TypedEnv<N, P, CO, Merge<CPT, Merge<CGT, CT>>, R>, MG extends MapValue<G, V>, R extends IEnvVarOptions["required"] = undefined, P extends IEnvVarOptions["prefix"] = undefined, V = undefined>(name: N, description: string, options?: Omit<IGlobalEnvVarOptions, "value"> & {
        required?: R;
        prefix?: P;
        value?: IEnvVarValueHandler<MapTypes<ValueOf<G>>, V>;
    }): Command<CPG, CPT, CO, CA, Merge<CG, MG>, CT, CGT, CP> {
        return this.env(name, description, { ...options, global: true } as IEnvVarOptions) as Command<any>;
    }
    /**
     ...
     */
    public env<N extends string, G extends TypedEnv<N, P, CO, Merge<CPT, Merge<CGT, CT>>, R>, MG extends MapValue<G, V>, R extends IEnvVarOptions["required"] = undefined, P extends IEnvVarOptions["prefix"] = undefined, V = undefined>(name: N, description: string, options: Omit<IEnvVarOptions, "value"> & {
        global: true;
        required?: R;
        prefix?: P;
        value?: IEnvVarValueHandler<MapTypes<ValueOf<G>>, V>;
    }): Command<CPG, CPT, CO, CA, Merge<CG, MG>, CT, CGT, CP>;
    public env<N extends string, O extends TypedEnv<N, P, CO, Merge<CPT, Merge<CGT, CT>>, R>, MO extends MapValue<O, V>, R extends IEnvVarOptions["required"] = undefined, P extends IEnvVarOptions["prefix"] = undefined, V = undefined>(name: N, description: string, options?: Omit<IEnvVarOptions, "value"> & {
        required?: R;
        prefix?: P;
        value?: IEnvVarValueHandler<MapTypes<ValueOf<O>>, V>;
    }): Command<CPG, CPT, Merge<CO, MO>, CA, CG, CT, CGT, CP>;
    public env(name: string, description: string, options?: IEnvVarOptions): Command<any> {
     ...
     */
    public async parse(args: string[] = Deno.args): Promise<CP extends Command<any> ? IParseResult<Record<string, unknown>, Array<unknown>, Record<string, unknown>, Record<string, unknown>, Record<string, unknown>, Record<string, unknown>, Record<string, unknown>, undefined> : IParseResult<MapTypes<CO>, MapTypes<CA>, MapTypes<CG>, MapTypes<CPG>, CT, CGT, CPT, CP>> {
        try {
            this.reset();
            ...
            if (args.length > 0) {
                ...
                if (subCommand) {
                    ...
                    return subCommand.parse(this.rawArgs.slice(1)) as any;
                }
            }
     ...
     */
    protected async execute(options: Record<string, unknown>, ...args: Array<unknown>): Promise<IParseResult> {
        if (this.fn) {
     ...
     * @param args Raw command line arguments.
     */
    protected parseFlags(args: string[], env: Record<string, unknown>): IFlagsResult & {
        actionOption?: IOption & {
            action: IAction;
        };
    } {
        try {
            let actionOption: IOption & {
                action: IAction;
            } | undefined;
            const result = parseFlags(args, {
                ...
                option: (option: IOption) => {
                    if (!actionOption && option.action) {
                        actionOption = option as IOption & {
                            action: IAction;
                        };
                    }
                },
    ...
    protected async parseEnvVars(): Promise<Record<string, unknown>> {
        ...
        for (const env of envVars) {
            const name = hasEnvPermissions && env.names.find((name: string) => !!Deno.env.get(name));
            if (name) {
    ...
    public getGlobalOptions(hidden?: boolean): IOption[] {
        const getOptions = (cmd: Command<any> | undefined, options: IOption[] = [], names: string[] = []): IOption[] => {
            if (cmd) {
    ...
    public getGlobalCommands(hidden?: boolean): Array<Command<any>> {
        const getCommands = (cmd: Command<any> | undefined, commands: Array<Command<any>> = [], names: string[] = []): Array<Command<any>> => {
            if (cmd) {
     ...
     * @param hidden Include hidden commands.
     */
    public getCommand<C extends Command<any>>(name: string, hidden?: boolean): C | undefined {
     ...
     * @param hidden Include hidden commands.
     */
    public getBaseCommand<C extends Command<any>>(name: string, hidden?: boolean): C | undefined {
        for (const cmd of this.commands.values()) {
            if (cmd._name === name || cmd.aliases.includes(name)) {
                return (cmd && (hidden || !cmd.isHidden) ? cmd : undefined) as C | undefined;
            }
        }
    }
    /**
     ...
     * @param hidden Include hidden commands.
     */
    public getGlobalCommand<C extends Command<any>>(name: string, hidden?: boolean): C | undefined {
        if (!this._parent) {
            return;
        }
    ...
    public getGlobalTypes(): IType[] {
        const getTypes = (cmd: Command<any> | undefined, types: IType[] = [], names: string[] = []): IType[] => {
            if (cmd) {
                if (cmd.types.size) {
    ...
    public getGlobalCompletions(): ICompletion[] {
        const getCompletions = (cmd: Command<any> | undefined, completions: ICompletion[] = [], names: string[] = []): ICompletion[] => {
            if (cmd) {
    ...
    public getGlobalEnvVars(hidden?: boolean): IEnvVar[] {
        const getEnvVars = (cmd: Command<any> | undefined, envVars: IEnvVar[] = [], names: string[] = []): IEnvVar[] => {
            if (cmd) {
 ...
 * - `<name...:type[]:completion>`
 */
type RestArgsListTypeCompletion<T extends string> = OptionalOrRequiredValue<`${RestValue}:${T}[]:${string}`>;
/**
 ...
 * - `<name...:type[]>`
 */
type RestArgsListType<T extends string> = OptionalOrRequiredValue<`${RestValue}:${T}[]`>;
/**
 ...
 * - `<name...:type:completion>`
 */
type RestArgsTypeCompletion<T extends string> = OptionalOrRequiredValue<`${RestValue}:${T}:${string}`>;
/**
 * Rest args with type.
 *
 * - `[...name:type]`
 ...
 * - `<name...:type>`
 */
type RestArgsType<T extends string> = OptionalOrRequiredValue<`${RestValue}:${T}`>;
/**
 * Rest args.
 * - `[...name]`
 * - `<...name>`
 ...
 * - `<name:type[]:completion>`
 */
type SingleArgListTypeCompletion<T extends string> = OptionalOrRequiredValue<`${string}:${T}[]:${string}`>;
/**
 ...
 * - `<name:type[]>`
 */
type SingleArgListType<T extends string> = OptionalOrRequiredValue<`${string}:${T}[]`>;
/**
 ...
 * - `<name:type:completion>`
 */
type SingleArgTypeCompletion<T extends string> = OptionalOrRequiredValue<`${string}:${T}:${string}`>;
/**
 ...
 * - `<name:type>`
 */
type SingleArgType<T extends string> = OptionalOrRequiredValue<`${string}:${T}`>;
/**
 * Single arg.
 *
 * - `[name]`
...
type ArgumentTypes<A extends string, T extends void | Record<string, any>> = A extends `${string} ${string}` ? TypedArguments<A, T> : ArgumentType<A, T>;
...
type NegatableOption<F extends string, CO, D, N extends string = OptionName<F>> = D extends undefined ? N extends keyof CO ? {
    [K in N]?: false;
} : {
    [K in N]: boolean;
} : {
...
type BooleanOption<N extends string, CO, R extends boolean | undefined = undefined, D = undefined> = N extends `no-${infer Name}` ? NegatableOption<Name, CO, D> : N extends `${infer Name}.${infer Rest}` ? (R extends true ? {
...
type ValueOption<N extends string, F extends string, V, R extends boolean | undefined = undefined, D = undefined> = N extends `${infer Name}.${infer RestName}` ? (R extends true ? {
    [K in OptionName<Name>]: ValueOption<RestName, F, V, R, D>;
} : {
    [K in OptionName<Name>]?: ValueOption<RestName, F, V, R, D>;
}) : (R extends true ? {
    [K in OptionName<N>]: GetArguments<F> extends `[${string}]` ? NonNullable<D> | true | ArgumentType<GetArguments<F>, V> : NonNullable<D> | ArgumentType<GetArguments<F>, V>;
} : {
    [K in OptionName<N>]?: GetArguments<F> extends `[${string}]` ? NonNullable<D> | true | ArgumentType<GetArguments<F>, V> : NonNullable<D> | ArgumentType<GetArguments<F>, V>;
});
type ValuesOption<T extends string, Rest extends string, V extends void | Record<string, any>, R extends boolean | undefined = undefined, D = undefined> = T extends `${infer Name}.${infer RestName}` ? (R extends true ? {
    [N in OptionName<Name>]: ValuesOption<RestName, Rest, V, R, D>;
} : {
    [N in OptionName<Name>]?: ValuesOption<RestName, Rest, V, R, D>;
}) : (R extends true ? {
    [N in OptionName<T>]: GetArguments<Rest> extends `[${string}]` ? NonNullable<D> | true | ArgumentTypes<GetArguments<Rest>, V> : NonNullable<D> | ArgumentTypes<GetArguments<Rest>, V>;
} : {
    [N in OptionName<T>]?: GetArguments<Rest> extends `[${string}]` ? NonNullable<D> | true | ArgumentTypes<GetArguments<Rest>, V> : NonNullable<D> | ArgumentTypes<GetArguments<Rest>, V>;
});
type MapValue<O, V, C = undefined> = V extends undefined ? C extends true ? {
    [K in keyof O]: O[K] extends (Record<string, unknown> | undefined) ? MapValue<O[K], V> : Array<NonNullable<O[K]>>;
} : O : {
    [K in keyof O]: O[K] extends (Record<string, unknown> | undefined) ? MapValue<O[K], V> : V;
};
...
type TypedCommandArguments<N extends string, T extends void | Record<string, any>> = number extends T ? any : N extends `${string} ${infer Args}` ? TypedArguments<Args, T> : [
];
...
type TypedType<Name extends string, Handler extends TypeOrTypeHandler<unknown>> = {
    [N in Name]: Handler;
};
type RequiredKeys<T> = {
...
type Spread<L, R> = L extends void ? R : R extends void ? L : Omit<L, keyof R>
