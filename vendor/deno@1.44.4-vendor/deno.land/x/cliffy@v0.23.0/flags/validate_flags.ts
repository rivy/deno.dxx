 ...
 */
export function validateFlags<T extends IFlagOptions = IFlagOptions>(opts: IParseOptions<T>, values: Record<string, unknown>, optionNameMap: Record<string, string> = {}): void {
 ...
 * @param optionNameMap
 */
function setDefaultValues<T extends IFlagOptions = IFlagOptions>(opts: IParseOptions<T>, values: Record<string, unknown>, optionNameMap: Record<string, string> = {}) {
...
function validateStandaloneOption(option: IFlagOptions, options: Array<IFlagOptionsMap>, optionNames: Array<string>, defaultValues: Record<string, boolean>): boolean {
...
function validateConflictingOptions(option: IFlagOptions, values: Record<string, unknown>): void {
...
function validateDependingOptions(option: IFlagOptions, values: Record<string, unknown>, defaultValues: Record<string, boolean>): void {
...
function validateRequiredValues(option: IFlagOptions, values: Record<string, unknown>, name: string): void {
...
function validateRequiredOptions<T extends IFlagOptions = IFlagOptions>(options: Array<IFlagOptionsMap>, values: Record<string, unknown>, opts: IParseOptions<T>): void {
    if (!opts.flags?.length) {
        return;
    }
    for (const option of opts.flags) {
