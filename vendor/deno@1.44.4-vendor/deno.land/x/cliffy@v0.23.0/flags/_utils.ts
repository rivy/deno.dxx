 ...
 */
export function getOption<O extends IFlagOptions>(flags: Array<O>, name: string): O | undefined {
    while (name[0] === "-") {
        name = name.slice(1);
    }
...
export function didYouMeanOption(option: string, options: Array<IFlagOptions>): string {
...
export function didYouMean(message: string, type: string, types: Array<string>): string {
...
export function matchWildCardOptions(name: string, flags: Array<IFlagOptions>): IFlagOptions | undefined {
...
function matchWildCardOption(name: string, option: IFlagOptions): IFlagOptions | false {
