/* global Deno */
import { assertNotEquals, assertStrictEquals, } from "../../../../../../deno.land/std@0.134.0/testing/asserts.ts";
import { basename, dirname, extname, posix, } from "../../../../../../deno.land/std@0.134.0/path/mod.ts";
...
const DENO_ENV_PERMITTED: boolean = (await Deno.permissions.query({ name: 'env' })).state === 'granted';
