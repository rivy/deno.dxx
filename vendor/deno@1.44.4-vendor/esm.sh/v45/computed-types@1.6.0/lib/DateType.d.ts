...
export declare class DateValidator<P extends FunctionParameters = [
    Date
    ...
    min(min: Date, error?: ErrorLike<[
        Date
    ]>): ValidatorProxy<this>;
    max(max: Date, error?: ErrorLike<[
        Date
    ]>): ValidatorProxy<this>;
    ...
    gt(boundary: Date, error?: ErrorLike<[
        Date
    ]>): ValidatorProxy<this>;
    lt(boundary: Date, error?: ErrorLike<[
        Date
    ]>): ValidatorProxy<this>;
    between(min: Date, max: Date, error?: ErrorLike<[
        Date
    ]>): ValidatorProxy<this>;
}
declare const DateType: ValidatorProxy<DateValidator<[
    input: Date
]>, FunctionType<Date, [
    input: Date
]>>;
