...
export default class Validator<F extends FunctionType> {
    ...
    equals<T extends ResolvedValue<ReturnType<F>>>(value: T, error?: ErrorLike<[
        ResolvedValue<ReturnType<F>>
    ]>): ValidatorProxy<this, FunctionType<T, Parameters<F>>>;
    test(tester: FunctionType<unknown, [
        ResolvedValue<ReturnType<F>>
    ]>, error?: ErrorLike<[
        ResolvedValue<ReturnType<F>>
    ]>): ValidatorProxy<this>;
    transform<T, V extends Validator<FunctionType<MaybeAsync<ReturnType<F>, T>, Parameters<F>>>>(fn: FunctionType<T, [
        ResolvedValue<ReturnType<F>>
    ]>, constructor?: ValidatorConstructor<V>): ValidatorProxy<V>;
    construct<P0 extends FunctionParameters>(fn: FunctionType<Parameters<F>, P0>): ValidatorProxy<this, FunctionType<ReturnType<F>, P0>>;
    optional<R extends ResolvedValue<ReturnType<F>> | undefined = undefined>(defaultValue?: R): ValidatorProxy<this, FunctionType<ReturnType<F> | R, MergeSchemaParameters<Parameters<F> | [
        (undefined | null)?
    ]>>>;
    strictOptional<R extends ResolvedValue<ReturnType<F>> | undefined = undefined>(defaultValue?: R): ValidatorProxy<this, FunctionType<ReturnType<F> | R, MergeSchemaParameters<Parameters<F> | [
        undefined?
    ]>>>;
