...
export declare type RecursiveMerge<T> = [
    T
] extends [
    Primitive
] ? T : [
...
export declare function deepConcat<A>(...values: [
    A
]): A;
export declare function deepConcat<A, B>(...values: [
    A,
    B
]): A & B;
export declare function deepConcat<A, B, C>(...values: [
    A,
    B,
    C
]): A & B & C;
export declare function deepConcat<A, B, C, D>(...values: [
    A,
    B,
    C,
    D
]): A & B & C & D;
export declare function deepConcat<A, B, C, D, E>(...values: [
    A,
    B,
    C,
    D,
...
export declare function deepConcat<A, B, C, D, E, F>(...values: [
    A,
    B,
    C,
    D,
...
export declare function deepConcat<A, B, C, D, E, F, G>(...values: [
    A,
    B,
    C,
    D,
...
export declare function deepConcat<A, B, C, D, E, F, G, H>(...values: [
    A,
    B,
    C,
    D,
