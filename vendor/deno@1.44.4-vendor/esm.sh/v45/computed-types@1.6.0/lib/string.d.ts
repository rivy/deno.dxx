...
export declare class StringValidator<P extends FunctionParameters = [
    string
    ...
    regexp(exp: RegExp | string, error?: ErrorLike<[
        string
    ]>): ValidatorProxy<this>;
}
declare const string: ValidatorProxy<StringValidator<[
    string
]>, FunctionType<string, [
    string
]>>;
