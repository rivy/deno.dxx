...
export declare class NumberValidator<P extends FunctionParameters = [
    number
]> extends Validator<FunctionType<number, P>> {
    float(error?: ErrorLike<[
        number
    ]>): ValidatorProxy<this>;
    integer(error?: ErrorLike<[
        number
    ]>): ValidatorProxy<this>;
    ...
    min(min: number, error?: ErrorLike<[
        number
    ]>): ValidatorProxy<this>;
    max(max: number, error?: ErrorLike<[
        number
    ]>): ValidatorProxy<this>;
    ...
    gt(boundary: number, error?: ErrorLike<[
        number
    ]>): ValidatorProxy<this>;
    lt(boundary: number, error?: ErrorLike<[
        number
    ]>): ValidatorProxy<this>;
    between(min: number, max: number, error?: ErrorLike<[
        number
    ]>): ValidatorProxy<this>;
}
declare const number: ValidatorProxy<NumberValidator<[
    number
]>, FunctionType<number, [
    number
]>>;
