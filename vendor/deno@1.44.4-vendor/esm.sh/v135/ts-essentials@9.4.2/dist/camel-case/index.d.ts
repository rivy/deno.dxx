...
]> = Type extends `${infer Word}${Separator}${infer Tail}` ? SeparatorCaseParser<Tail, [
    ...Tuple,
    Lowercase<Word>
...
]> = Type extends "" ? Tuple : Type extends `${WordInCamelCase<Type>}${infer Tail}` ? Type extends `${infer Word}${Tail}` ? CamelCaseParser<Uncapitalize<Tail>, [
    ...Tuple,
    Lowercase<Word>
]> : never : never;
declare type PascalCaseParser<Type> = Type extends string ? CamelCaseParser<Uncapitalize<Type>> : never;
declare type SplitAnyCase<Type> = IncludesSeparator<Type> extends true ? SeparatorCaseParser<Type> : IsOneWord<Type> extends true ? [
    Lowercase<Type & string>
] : IsCamelCase<Type> extends true ? CamelCaseParser<Type> : IsPascalCase<Type> extends true ? PascalCaseParser<Type> : [
];
declare type PascalCapitalizer<Type, Tuple extends readonly any[] = [
    ...
    ...Tuple,
    Capitalize<Head>
]> : PascalCapitalizer<Tail, Tuple> : Tuple;
...
declare type Join<Type, JoinedString extends string = ""> = Type extends [
    infer Head,
    ...infer Tail
] ? Head extends string ? Join<Tail, `${JoinedString}${Head}`> : Join<Tail> : JoinedString;
