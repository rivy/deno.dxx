...
// ... for deno: 1.46.3 (last Deno-v1); wrapped in "DenoV1" namespace

// /// <reference no-default-lib="true" />
// /// <reference lib="esnext" />

declare namespace DenoV1NS {
export type RID = number;
//---- <https://cdn.jsdelivr.net/gh/denoland/deno@v1.46.3/cli/tsc/dts/lib.deno.ns.d.ts>
...
//---- <https://cdn.jsdelivr.net/gh/denoland/deno@v1.46.3/cli/tsc/dts/lib.deno_net.d.ts>
namespace Deno {
  /** @category Network */
