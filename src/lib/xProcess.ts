...
// ToDO: add is-standalone test for Deno-v1.30..Deno-v1.39 ; discussion of including `--_is-compiled-binary_` option in compilation at <https://github.com/denoland/deno/issues/15996>
export const likelyIsStandalone =
	...
	/* Deno-v1.40+ ~ projectURL (from import.meta.url), for compiled scripts, ends with "deno-compile-.../REPO_DIR_BASENAME/" */
