...
export { mergeReadableStreams } from 'https://deno.land/std@0.150.0/streams/merge.ts';

// * import needed stable portions of `std/fs`
import { exists, existsSync } from 'https://deno.land/std@0.150.0/fs/exists.ts';
import { expandGlob, expandGlobSync } from 'https://deno.land/std@0.150.0/fs/expand_glob.ts';
...
export { default as $osPaths } from 'https://deno.land/x/os_paths@v7.1.1/src/mod.deno.ts';
export * as $semver from 'https://deno.land/x/semver@v1.4.0/mod.ts';
export * as $tty from 'https://deno.land/x/tty@0.1.4/mod.ts';
export { default as $xdgAppPaths } from 'https://deno.land/x/xdg_app_paths@v8.1.1/src/mod.deno.ts';
...
export { assert, assertEquals, equal } from 'https://deno.land/std@0.150.0/testing/asserts.ts';
